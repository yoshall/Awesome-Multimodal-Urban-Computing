...
- **ArcGIS**: [Developers ArcGIS](https://developers.arcgis.com/)
- **PlanetScope (satellite images)**: [Planet Docs](https://developers.planet.com/docs/data/planetscope/)
- **Google Earth (satellite images)**: [Google Maps Documentation](https://developers.google.com/maps/documentation/)
- (... add more as needed ...)

#### Street View Image

- **Baidu Map API (street view images)**: [Baidu Maps](https://lbsyun.baidu.com/)
- **Google Street API (street view images)**: [Google Maps API](https://developers.google.com/maps/)
- (... add more as needed ...)

#### POIs (Point of Interest)

- **Tencent Map Service(POIs)**: [lbs qq](https://lbs.qq.com/getPoint/)
- **WeChat POIs**: [WeChat](https://open.weixin.qq.com/)
- (... add more as needed ...)

#### Map

- **US Census Bureau**: [US Census Bureau Data](https://www.census.gov/data.html)
- **OpenStreetMap(digital maps)**: [OpenStreetMap](https://www.openstreetmap.org/)
- (... add more as needed ...)
...
- **California-PEMS**: [PEMS](http://pems.dot.ca.gov/)
- **METR-LA**: [Metro Net](https://www.metro.net/)
- (... add more as needed ...)

#### Traffic Flow

- **DiDi (Traffic flows)**: [DiDi Research](https://outreach.didichuxing.com/research/opendata/)
- **BikeNYC**: [CitiBike NYC](https://citibikenyc.com/)
- (... add more as needed ...)

#### Logistics

- **JD Logistics in Beijing**: [JD Logistics](https://.../)
- (... add more as needed ...)

#### Road Network

- **Beijing and North America Road Network**: [OpenStreetMap](https://www.openstreetmap.org/)
- (... add more as needed ...)

### Social Networking Data

- **Twitter (check-in & geo-tagged tweets)**: [Twitter Developer Docs](https://developer.twitter.com/en/docs/)
- (... add more as needed ...)
